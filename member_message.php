...
$_result = _query("SELECT tg_id,tg_fromuser,tg_state,tg_content,tg_date,tg_touser FROM tg_message WHERE tg_touser='{$_COOKIE['username']}' ORDER BY tg_date DESC LIMIT " . $_pagenum . "," . $_pagesize)
                ...
                while (!!$_rows = _fetch_array_list($_result)) {
                    ...
                    <tr>
                        ...
                        <td><a href="member_message_detail.php?id=<?php echo $_html['id'] ?>"
                               title="<?php echo $_html ['content'] ?>"><?php echo $_html['content_html'] ?></a>
                        </td>
